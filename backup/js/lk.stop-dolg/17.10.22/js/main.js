    ...
    if (target.hasAttribute("data-payment-id")) {
      ...
      popup.innerHTML = `
                <div class="popup__content">
                    ...
                    <a href="${blank}" target="_blank" class="button">Скачать бланк</a>
                    <a href="${id}" target="_blank" class="button button--green">Перейти к оплате</a>
                </div>
            `;
    ...
    <div class="Expander__trigger" 
      ...
      :class="open?'active':'beforeBorder'">
        ...
        <svg
          ...
          <path d="M13.3147 14L0 27.3147L0.685315 28L14.6853 14L0.685315 1.90735e-06L0 0.685316L13.3147 14Z" 
          fill="white"/>
        </svg>
    </div>

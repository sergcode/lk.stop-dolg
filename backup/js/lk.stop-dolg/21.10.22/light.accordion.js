...
// function sendFilesActiveTask(thisElem) {
//     return;
//     let accordionsParentBtn = document.querySelectorAll('.task__accordion-btn'),
...
//
//             const sendBtn = thisElem.querySelector('button.attach__button .button');
//             sendBtn.textContent = 'Подождите!';
//             let btnSendFiles = thisElem.querySelector('.attach__button[name="taskAccordionAttach"]'),
//
//                 if
//             (!btnSendFiles.hasAttribute('disabled'))
//             {
